  ...
  return (
    <div>
      <div className="cover container col-xxl-12 px-4 py-5">
        <div className="row flex-md-row-reverse align-items-center g-5 py-5">
          <div className="col-10 col-sm-8 col-lg-5">
            <img src="./public/Emilee-cover.jpg" className="d-block mx-lg-auto img-fluid" id="cover" loading="lazy" alt="Emilee Cover" />
          </div>
        ...
        <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
              <img className="featured-img" src="public/Washes.jpg" height="300em" alt="Dog grooming service in Hurricane, Utah - Washes" />
            </div>
          ...
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
              <img className="featured-img" src="public/cuts.jpg" height="300em" alt="Pet haircut specialist in Hurricane, Utah - styling" />
            </div>
          ...
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
              <img className="featured-img" src="public/Styling.jpg" height="300em" alt="Professional pet stylist in Hurricane, Utah - Styling" />
            </div>
      ...
      <div className="slides container">
        ...
        >
          <SwiperSlide><img src="public/Slider1.jpg" alt="Slide 1" /></SwiperSlide>
          <SwiperSlide><img src="public/Slider2.jpg" alt="Slide 2" /></SwiperSlide>
          <SwiperSlide><img src="public/Slider3.jpg" alt="Slide 3" /></SwiperSlide>
          <SwiperSlide><img src="public/Slider4.jpg" alt="Slide 4" /></SwiperSlide>
          <SwiperSlide><img src="public/Slider5.jpg" alt="Slide 5" /></SwiperSlide>
        </Swiper>
      </div>
    </div>
  );
